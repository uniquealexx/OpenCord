...
export const serverEventSchema = z.discriminatedUnion("type", [
  ...
  z.object({ type: z.literal("server.snapshot"), server: z.object({ id: z.string().uuid(), name: z.string(), channels: z.array(channelSchema), members: z.array(memberSchema) }) }),
  ...
  z.object({ type: z.literal("error"), requestId: requestIdSchema.nullable(), code: z.enum(["INVALID_EVENT", "AUTH_REQUIRED", "AUTH_FAILED", "PROTOCOL_MISMATCH", "NOT_FOUND", "INTERNAL_ERROR"]), message: z.string() }),
]);
