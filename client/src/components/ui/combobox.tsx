...
export function Combobox({ label, value, placeholder, icon: Icon, options, onChange }: { label: string; value: string; placeholder: string; icon: typeof User; options: { value: string; label: string }[]; onChange: (value: string) => void }): React.ReactElement {
