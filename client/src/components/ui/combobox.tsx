...
export function Combobox({ label, value, placeholder, icon: Icon, options, onChange, disabled = false, clearable = true, className }: { label: string; value: string; placeholder: string; icon: typeof User; options: { value: string; label: string }[]; onChange: (value: string) => void; disabled?: boolean; clearable?: boolean; className?: string }): React.ReactElement {
