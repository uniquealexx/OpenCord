...
export function EmojiPicker({ disabled = false, onSelect }: { disabled?: boolean; onSelect: (emoji: string) => void }): React.ReactElement {
  ...
  return <div ref={rootRef} className="relative shrink-0">
    ...
    {open && <div role="dialog" aria-label="Панель эмодзи" className="absolute bottom-12 right-0 z-50 w-[344px] overflow-hidden rounded-2xl border border-white/10 bg-[#151a27] shadow-[0_22px_70px_rgba(0,0,0,.65)]">
