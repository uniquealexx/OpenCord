...
it("combines Discord-like search filters and opens a result", async () => {
  ...
  expect(onSearch).toHaveBeenCalledWith({ query: "котик", authorId: member.id, channelId: channel.id, contentTypes: ["image"], pinnedOnly: false, offset: 0, limit: 25 });

  const message = { id: "22959e6f-7ea9-41d9-8be3-f412354d3e95", channelId: channel.id, authorId: member.id, authorName: member.username, authorAvatar: null, content: "Вот котик", createdAt: "2026-08-07T00:00:00.000Z", editedAt: null, attachments: [], mentions: [], reactions: [], kind: "chat" as const, targetUserId: null, anonymous: false, replyToMessageId: null, pinned: false, pinnedAt: null };
...
it("searches every attachment type without requiring text", async () => {
  ...
  expect(onSearch).toHaveBeenCalledWith({ query: "", authorId: null, channelId: null, contentTypes: ["image", "video", "file"], pinnedOnly: false, offset: 0, limit: 25 });
});
...
it("renders mentions as readable tags instead of raw markers", () => {
  ...
  const message = { id: "22959e6f-7ea9-41d9-8be3-f412354d3e95", channelId: channel.id, authorId: member.id, authorName: member.username, authorAvatar: null, content: "Привет <@user-2>!", createdAt: "2026-08-07T00:00:00.000Z", editedAt: null, attachments: [], mentions: [{ userId: "user-2" }], reactions: [], kind: "chat" as const, targetUserId: null, anonymous: false, replyToMessageId: null, pinned: false, pinnedAt: null };
...
it("renders a mention of a removed member as unknown user", () => {
  const message = { id: "22959e6f-7ea9-41d9-8be3-f412354d3e95", channelId: channel.id, authorId: member.id, authorName: member.username, authorAvatar: null, content: "Привет <@user-gone>!", createdAt: "2026-08-07T00:00:00.000Z", editedAt: null, attachments: [], mentions: [{ userId: "user-gone" }], reactions: [], kind: "chat" as const, targetUserId: null, anonymous: false, replyToMessageId: null, pinned: false, pinnedAt: null };
...
it("renders localized labels for private and anonymous message results", () => {
  const apm = { id: "42959e6f-7ea9-41d9-8be3-f412354d3e95", channelId: channel.id, authorId: member.id, authorName: member.username, authorAvatar: null, content: "Секрет", createdAt: "2026-08-07T00:00:00.000Z", editedAt: null, attachments: [], mentions: [], reactions: [], kind: "apm" as const, targetUserId: "user-2", anonymous: true, replyToMessageId: null, pinned: false, pinnedAt: null };
  const pm = { id: "52959e6f-7ea9-41d9-8be3-f412354d3e95", channelId: channel.id, authorId: member.id, authorName: member.username, authorAvatar: null, content: "Личное", createdAt: "2026-08-07T00:00:00.000Z", editedAt: null, attachments: [], mentions: [], reactions: [], kind: "pm" as const, targetUserId: "user-2", anonymous: false, replyToMessageId: null, pinned: false, pinnedAt: null };
