...
- **Electron main** управляет окном, локальным состоянием, защищённым ключом идентичности, ограниченной SSH-операцией развёртывания и потоковой передачей выбранных пользователем вложений.
